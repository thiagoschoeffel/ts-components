  ...
  <div class="w-full min-w-0">
    ...
    <SelectRoot
      ...
      <SelectTrigger
        ...
        <SelectIcon
          class="inline-flex shrink-0 items-center justify-center self-center leading-none text-slate-400 transition-transform duration-150 group-data-[state=open]/multiselect:rotate-180"
